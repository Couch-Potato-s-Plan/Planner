...
public class SettingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bottomNavigation = (BottomNavigationView) view.findViewById(R.id.bottomNavi);
...
/*
        database.child("theme_num").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    theme_num = snapshot.getValue(Integer.class);
